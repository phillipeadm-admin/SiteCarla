                    ...
                    {products.map((product, index) => (
                        ...
                        >
                            <div className="w-full lg:w-1/2 relative group">
                                {product.imageUrl ? (
                                    <div className="relative aspect-square md:aspect-[4/3] overflow-hidden rounded-[120px_40px_120px_40px] border border-[#EBE5DB] bg-white shadow-sm transition-all duration-700 hover:shadow-2xl hover:-translate-y-2 max-w-[600px] mx-auto">
                                    ...
                                    <div className="w-full aspect-square md:aspect-[4/3] bg-[#EBE5DB] flex items-center justify-center rounded-[120px_40px_120px_40px] max-w-[600px] mx-auto">
