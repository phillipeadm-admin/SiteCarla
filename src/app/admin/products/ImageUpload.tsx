...
export default function ImageUpload({ onUpload, defaultValue }: ImageUploadProps) {
    ...
    return (
        <div className="space-y-4">
            <div className="relative aspect-video w-full rounded-2xl bg-[#FAF5EF] border-2 border-dashed border-[#EBE6DF] flex flex-col items-center justify-center overflow-hidden group">
                {preview ? (
                    <>
                    ...
                    <div className="flex flex-col items-center text-[#8B6E5B]">
                        <LucideImage className="w-8 h-8 mb-2 opacity-50" />
                ...
                {uploading && (
                    <div className="absolute inset-0 bg-white/80 backdrop-blur-sm flex items-center justify-center">
                        <Loader2 className="w-6 h-6 text-[#3B2B23] animate-spin" />
                    </div>
                )}
            </div>
